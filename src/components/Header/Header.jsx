  ...
  return (
	...
	C400.8,321.2,388,340.4,373.6,357.2z M377.6,270.8c4.8-15.2,7.2-31.2,8-48l40-1.6c0,22.4-4,43.2-10.4,63.2L377.6,270.8z"
      ...
      <div className={style.header__right}>
        <Link to="/profile">{/* <div className={style.button__click}>Мой профиль</div> */}</Link>
        <div className={style.btn__click}>
          {registration ? (
            <Link to="/profile">
              <div className={style.svg__btn}>
                <svg
                  viewBox="0 0 448 512"
                  width="22px"
                  height="22px"
          ...
          {registration ? (
            <div className={style.hover__icon} style={{ display: "none" }}>
              <div className={style.title}>Личный кабинет</div>
              <Link to="/login">
                <div className={style.button__click}>Перейти</div>
              </Link>
            </div>
          ) : (
            <div className={style.hover__icon}>
              <div className={style.title}>Личный кабинет</div>
              <Link to="/login">
                <div className={style.button__click}>Перейти</div>
              </Link>
